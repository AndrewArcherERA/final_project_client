...
function Suppliers() {
    ...
    async function getSuppliers() {
        try {
            ...
            const supplierList = await axios.get('http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/supplierPage/getSuppliers', config);
    ...
    async function getSelectedSupplierProds(supplier_id) {
        try {
            ...
            let prods = await axios.get(`http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/supplierPage/getSupplierProds/${supplier_id}`, config);
