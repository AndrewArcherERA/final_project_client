...
function ConsumerDashboard() {
    ...
    async function getStores() {
        ...
        const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/consumerStore/getStores/${id}`;
    ...
    async function handleCreateStore(e) {
        ...
        const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/consumerStore/createStore`;
    ...
    async function handleCreateWarehouse(e) {
        ...
        const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/account/createWarehouse`;
        await axios.post(url, body, config).then((response) => {
    ...
    async function handleUpdateWarehouse(e) {
        ...
        const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/account/updateWarehouse`;
        await axios.post(url, body, config).then((response) => {
            setWarehouse(response.data[0]);
    ...
    async function getWarehouses() {
        ...
        const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/account/getWarehouses`;
        let response = await axios.get(url, config);
        setWarehouse(response.data[0]);
    ...
    async function deleteWarehouse(consumer_id) {
        ...
        const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/account/deleteWarehouse/${consumer_id}`;
    ...
    async function handleCheckout() {
        try {
            ...
            const url = 'http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/orders/createConsumerOrder';
            const data = {
...
function ConsumerStoreAccordian({
    ...
    async function handleUpdateLocation(e) {
        ...
        try {
            ...
            const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/consumerStore/updateStore`;
    ...
    async function handleDeleteLocation() {
        try {
            ...
            const url = `http://fp-server-again-env.eba-mtq3upkp.us-east-1.elasticbeanstalk.com/consumerStore/deleteStore`;
